...
var createSecretCmd = &cobra.Command{
    Use:   "create-secret",
    Short: "Create a Vault Secret within the specified box",
...
func init() {
    ...
    createSecretCmd.Flags().StringP("boxid", "b", "",
                                    "Id or name of the Box")
    createSecretCmd.Flags().StringP("name", "n", "",
                                    "Name of the Secret")
    createSecretCmd.Flags().StringP("description", "d", "",
                                    "Short description for the Secret")
    createSecretCmd.Flags().StringP("data", "D", "",
                                    "Secret data")
    createSecretCmd.Flags().StringArrayP("datakey", "X", []string{},
                                         "The key to associate with the Secret data")
    createSecretCmd.Flags().StringArrayP("datavalue", "Y", []string{},
                                         "Value corresponding to specific Secret data")

    // managed type specific commands
    createSecretCmd.Flags().StringP("managed-type", "m", "",
                                    "Type of managed secret (supported: ESXiHostAccount)")
    createSecretCmd.Flags().StringP("ESXihost", "H", "",
                                    "ESXi host address(required) if --managed-type set to ESXiHostAccount")
    createSecretCmd.Flags().StringP("ESXiuser", "U", "",
                                    "ESXi username(required) if --managed-type set to ESXiHostAccount")
    createSecretCmd.Flags().StringP("ESXipasswd", "P", "",
                                    "ESXi password(required) if --managed-type set to ESXiHostAccount")
    createSecretCmd.Flags().StringP("ESXi-tls-version", "T", "",
                                    "TLS version(optional) to use while connecting to ESXi " +
                                    "if --managed-type set to ESXiHostAccount")
    createSecretCmd.Flags().StringP("ESXicacert", "c", "",
                                    "CA Certificate(optional) to use while connecting to ESXi " +
                                    "if --managed-type set to ESXiHostAccount")
    createSecretCmd.Flags().StringP("master-boxid", "B", "",
                                    "Box id or name of master secret(optional), if " +
                                    "--managed-type set to ESXiHostAccount")
    createSecretCmd.Flags().StringP("master-secretid", "I", "",
                                    "Master Secret id or name(optional), if " +
                                    "--managed-type set to ESXiHostAccount")

    createSecretCmd.Flags().StringP("lease-duration", "l", "",
                                    "Lease duration to enforce for the Secret. This property set " +
                                    "here, takes precedence over Box property")
    createSecretCmd.Flags().StringP("lease-renewable", "L", "",
    ...
    createSecretCmd.Flags().StringP("rotation-duration", "r", "",
                                    "Duration on which Secret will be rotated. Behavior depends " +
                                    "on \"rotation force\". This property set " +
                                    "here, takes precedence over Box property.")
    createSecretCmd.Flags().StringP("rotation-force", "f", "",
    ...
    createSecretCmd.Flags().StringP("rotation-on-checkin", "o", "",
                                  ...
                                  "This property set here takes precedence over Box property.")
    createSecretCmd.Flags().StringP("exclusive-checkout", "x", "",
                                    "If this flag is set, all Secret checkouts " +
                                    "would be exclusive. Supports one of enable or disable. " +
                                    "This property set here takes precedence over Box property")
    createSecretCmd.Flags().StringArrayP("tagkey", "t", []string{},
                                         "Tag key to associate with the Secret. " +
                                         "This option is repeatable.")
    createSecretCmd.Flags().StringArrayP("tagvalue", "v", []string{},
                                         "Tag value to associate with the Secret. " +
                                         "This option is repeatable.")
    createSecretCmd.Flags().StringP("expires-at", "e", "",
                                    "Expiration time in RFC 3339 format. " +
                                    "Set \"never\" to never expire")

    // mark mandatory fields as required
    createSecretCmd.MarkFlagRequired("boxid")
    createSecretCmd.MarkFlagRequired("name")
}
