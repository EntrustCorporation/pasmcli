...
// updateVaultSettingsCmd represents the update-vault-settings command
var updateVaultSettingsCmd = &cobra.Command{
    Use:   "update-vault-settings",
    Short: "Update Vault settings",
    Run: func(cmd *cobra.Command, args []string) {
        ...
        // now POST
        endpoint := GetEndPoint("", "1.0", "UpdateVaultSettings")
...
func init() {
    rootCmd.AddCommand(updateVaultSettingsCmd)
    updateVaultSettingsCmd.Flags().StringP("degraded-mode-availability", "d", "",
                                 "Degraded mode availability. ")
    updateVaultSettingsCmd.Flags().StringP("oidc-enabled", "o", "",
                                 "OIDC enabled flag. ")
    updateVaultSettingsCmd.Flags().IntP("revision", "R", 0,
                              "Revision number of the box")

    // mark mandatory fields as required
    updateVaultSettingsCmd.MarkFlagRequired("revision")
}
