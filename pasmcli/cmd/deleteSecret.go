...
var deleteSecretCmd = &cobra.Command{
    ...
    Run: func(cmd *cobra.Command, args []string) {
        ...
        // now POST
        endpoint := GetEndPoint("", "1.0", "DeleteSecret")
...
func init() {
    ...
    deleteSecretCmd.Flags().StringP("boxid", "b", "",
                                    "Id or name of the Box where the Secret is")
    deleteSecretCmd.Flags().StringP("secretid", "s", "",
                                    "Id or name of the Secret to be deleted")

    // mark mandatory fields as required
    deleteSecretCmd.MarkFlagRequired("boxid")
    deleteSecretCmd.MarkFlagRequired("secretid")
}
